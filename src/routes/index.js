...
const Campaigns = async(() => import("../pages/tables/Campaigns"));
const CampaignReport = async(() => import("../pages/tables/CampaignReport"));
const MailListReport = async(() => import("../pages/tables/MailListReport"));
const CompanyDataScreen = async(() =>
  import("../pages/tables/CompanyDataScreen")
);
const ListsFirstScreen = async(() =>
  import("../pages/tables/ListsFirstScreen")
);
const NewProspectScreen = async(() =>
  import("../pages/tables/NewProspectScreen")
);
const NewEmailSearchScreen = async(() =>
  import("../pages/tables/NewEmailSearchScreen")
);
const DropDownTest = async(() => import("../pages/tables/DropDownTest"));
const NewEmailVerifierScreen = async(() =>
  import("../pages/tables/NewEmailVerifierScreen")
);
const NewEmailFinderScreen = async(() =>
  import("../pages/tables/NewEmailFinderScreen")
);
const NewLocalBusinessesScreen = async(() =>
  import("../pages/tables/NewLocalBusinessesScreen")
);
const BulkMainScreen = async(() => import("../pages/tables/BulkMainScreen"));
const BulkDomainScreen = async(() =>
  import("../pages/tables/BulkDomainScreen")
);
const BulkEmailFinderScreen = async(() =>
  import("../pages/tables/BulkEmailFinderScreen")
);
const BulkEmailVerifierScreen = async(() =>
  import("../pages/tables/BulkEmailVerifierScreen")
);
...
const tablesRoutes = {
  ...
  children: [
    ...
    {
      path: "/tables/campaigns",
      name: "Campaigns",
      component: Campaigns,
    },
    {
      path: "/tables/campaign-report",
      name: "Campaign Report",
      component: CampaignReport,
    },
    {
      path: "/tables/mail-list-report",
      name: "Mail List Report",
      component: MailListReport,
    },
    {
      path: "/tables/company-data",
      name: "Company Data",
      component: CompanyDataScreen,
    },
    {
      path: "/tables/lists-first",
      name: "Lists First",
      component: ListsFirstScreen,
    },
    {
      path: "/tables/new-prospect",
      name: "New Prospect",
      component: NewProspectScreen,
    },
    {
      path: "/tables/new-email",
      name: "New Email Search",
      component: NewEmailSearchScreen,
    },
    {
      path: "/tables/dropdown-test",
      name: "Drop Down Test",
      component: DropDownTest,
    },
    {
      path: "/tables/new-email-verifier",
      name: "New Email Verifier",
      component: NewEmailVerifierScreen,
    },
    {
      path: "/tables/new-email-finder",
      name: "New Email Finder",
      component: NewEmailFinderScreen,
    },
    {
      path: "/tables/new-local-businesses",
      name: "New Local Businesses",
      component: NewLocalBusinessesScreen,
    },
    {
      path: "/tables/bulk-main",
      name: "Bulk Main",
      component: BulkMainScreen,
    },
    {
      path: "/tables/bulk-domain",
      name: "Bulk Domain",
      component: BulkDomainScreen,
    },
    {
      path: "/tables/bulk-email-finder",
      name: "Bulk Email Finder",
      component: BulkEmailFinderScreen,
    },
    {
      path: "/tables/bulk-email-verifier",
      name: "Bulk Email Verifier",
      component: BulkEmailVerifierScreen,
    },
  ],
  component: null,
};
